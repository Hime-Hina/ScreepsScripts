...
1. Add RED tests in `test/unit/creeps/worker-decision.test.ts` for upgrader withdraw/upgrade/fallback.
2. Implement `planUpgraderAction` in `src/creeps/worker-decision.ts` with minimal helper reuse.
